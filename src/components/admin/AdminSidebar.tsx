...
import { LayoutDashboard, CalendarDays, Users, BarChart3, Settings, ExternalLink, LogOut, X, Menu, Bus, ClipboardList } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { label: "프로그램 신청", href: "/admin/programs", icon: ClipboardList },

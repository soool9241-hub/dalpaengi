...
const spaces = [
  {
    ...
    capacity: "전체 이용",
    size: "30평+",
    desc: "60명 이상 수용 가능한 넓은 거실에 100인치 대형 TV, 전자레인지 4개, 정수기, 개별 난방기가 설치되어 있습니다. 마당 앞 야외 바베큐 공간에서 그릴 최대 8개 동시 이용 가능하며, 야외 식사 공간도 마련되어 있습니다.",
    amenities: ["100인치 TV", "전자레인지 4개", "정수기", "개별 난방기", "야외 바베큐 (최대 8개)", "야외 식사공간"],
